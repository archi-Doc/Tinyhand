...
public ref partial struct TinyhandReaderB
{
    ...
    public TinyhandReaderB Clone(in ReadOnlySpan<byte> span) => new TinyhandReaderB(span)
    {
    ...
    /// <summary>
    /// Creates a new <see cref="TinyhandReaderB"/> at this reader's current position.
    /// </summary>
    /// <returns>A new <see cref="TinyhandReaderB"/>.</returns>
    public TinyhandReaderB Fork() => this;
