        ...
        public byte ReadUInt8()
        {
            ...
            switch (code)
            {
                ...
                case MessagePackCode.Int8:
                    ThrowInsufficientBufferUnless(this.TryReadUnmanaged(out sbyte sbyteResult));
                    return checked((byte)sbyteResult);
                case MessagePackCode.UInt16:
                    ThrowInsufficientBufferUnless(this.TryReadUnmanaged(out ushort ushortResult));
                    return checked((byte)ushortResult);
                case MessagePackCode.Int16:
                    ThrowInsufficientBufferUnless(this.TryReadUnmanaged(out short shortResult));
                    return checked((byte)shortResult);
                case MessagePackCode.UInt32:
                    ThrowInsufficientBufferUnless(this.TryReadUnmanaged(out uint uintResult));
                    return checked((byte)uintResult);
                case MessagePackCode.Int32:
                    ThrowInsufficientBufferUnless(this.TryReadUnmanaged(out int intResult));
                    return checked((byte)intResult);
                case MessagePackCode.UInt64:
                    ThrowInsufficientBufferUnless(this.TryReadUnmanaged(out ulong ulongResult));
                    return checked((byte)ulongResult);
                case MessagePackCode.Int64:
                    ThrowInsufficientBufferUnless(this.TryReadUnmanaged(out long longResult));
