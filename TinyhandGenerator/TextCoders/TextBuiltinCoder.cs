...
{
    public sealed class TextBuiltinCoder : ICoderResolver
    {
        /// <summary>
        /// The singleton instance that can be used.
        /// </summary>
        public static readonly TextBuiltinCoder Instance = new TextBuiltinCoder();

        public readonly Dictionary<string, ITinyhandTextCoder> NameToCoder = new()
        {
            // Primitive
