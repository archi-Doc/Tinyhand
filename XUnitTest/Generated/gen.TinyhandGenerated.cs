...
namespace Tinyhand.Formatters
{
    static class Generated
    {
        ...
        internal static void __gen__load()
        {
            ...
            GeneratedResolver.Instance.SetFormatter<XUnitTest.PrimitiveIntKeyClass>(new __gen__tf__0001());
            GeneratedResolver.Instance.SetFormatter<XUnitTest.PrimitiveStringKeyClass>(new __gen__tf__0002());
        }
        ...
        class __gen__tf__0001: ITinyhandFormatter<XUnitTest.PrimitiveIntKeyClass>
        {
        ...
        class __gen__tf__0002: ITinyhandFormatter<XUnitTest.PrimitiveStringKeyClass>
        {
